# Next two lines need because of: https://github.com/devcontainers/features/tree/main/src/node#using-nvm-from-postcreatecommand-or-another-lifecycle-command
. ${NVM_DIR}/nvm.sh
nvm install 18.16.1
