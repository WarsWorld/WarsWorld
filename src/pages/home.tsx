  ...
  return (
    <section>
      ...
      <div className="">
        ...
        <p>
          We are in the process of refactoring "AW-Competitive"/Wars World demo
          (FemboyDeveloper, Rey, Yeti et al.) into Typescript/React/Next.js +
          tRPC + Prisma/SQL (FunctionDJ's idea)
        </p>
        <p>
          ...
          . Make sure you've talked with us or gotten confirmation that no one
          else is working on that task. Otherwise, you risk working on something
