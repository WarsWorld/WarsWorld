...
export const vonBoltAWDS: COProperties = {
  ...
  powers: {
    superCOPower: {
      name: "Ex Machina",
      description: "Creates a lightning bolt that strikes a position and deals 3 HP of damage and immobilizes all units at distance 2 or less from the center. The strike position is decided randomly between most HP or most value in damages, subtracting own units hp/value.",
      stars: 10,
