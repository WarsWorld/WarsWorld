    ...
    <footer>
      <div className = 'footerGrid'>
        ...
        <nav className='iconElements'>
          <img className='iconButtonElementGridRedditF'src={rLogoPath} alt="Reddit Logo" />
          <img className='iconButtonElementGridDiscordF'src={dLogoPath} alt="Discord Logo" />
          <img className='iconButtonElementGridGhF'src={gLogoPath} alt="GitHub Logo" />
        </nav>
