...
import type { ArmySpritesheetData, SheetNames, SpritesheetDataByArmy, } from "../../gameFunction/get-sprite-sheets";
...
export async function loadSpritesFromSpriteMap(spriteMap: SpritesheetDataByArmy): Promise<LoadedSpriteSheet> {
